      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) => setFormData((prev: any) => ({ ...prev, track_inventory: checked }))}
          />
        </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData((prev: any) => ({ ...prev, stock_quantity: parseFloat(e.target.value) || 0 }))}
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData((prev: any) => ({ ...prev, reorder_level: parseFloat(e.target.value) || 0 }))}
                />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData((prev: any) => ({ ...prev, cost_price: parseFloat(e.target.value) || 0 }))}
                />
