-- =====================================================
-- Enhanced Inventory System - Purchase Orders & Valuation (FIXED)
-- =====================================================
-- Adds purchase order management and inventory valuation tracking
-- IMPORTANT: Run create_inventory_tables_fixed.sql FIRST!
-- =====================================================

-- Drop existing tables if they exist (in correct order due to dependencies)
DROP TABLE IF EXISTS inventory_valuation_items CASCADE;
...
CREATE INDEX idx_grn_date ON goods_received_notes(receipt_date);

-- Valuations
CREATE INDEX idx_valuations_date ON inventory_valuations(valuation_date);
CREATE INDEX idx_valuations_type ON inventory_valuations(valuation_type);
CREATE INDEX idx_valuations_status ON inventory_valuations(status);

-- Valuation Items
CREATE INDEX idx_valuation_items_valuation ON inventory_valuation_items(valuation_id);
CREATE INDEX idx_valuation_items_inventory ON inventory_valuation_items(inventory_item_id);
